(function () {
    ...
    function Dlna(object) {
      ...
      this.load = function (url) {
        ...
        network["native"](url, this.draw.bind(this), function () {
          if (path.length == 1) {
      ...
      this.managers = function () {
        ...
        var update = function update() {
          ...
          network["native"](window.lampac_dlna_adres + '/tracker/managers', function (data) {
            managers = data;
            _this2.progress();
          });
        };
      ...
      this.append = function (data) {
        ...
        data.forEach(function (element) {
          ...
          card.find('.card__img').attr('src', element.img || "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg'/%3E");
            ...
            if (!element.back) {
              ...
              Lampa.Select.show({
                ...
                onSelect: function onSelect(a) {
                  if (a["delete"]) {
                    if (download) {
                      network["native"](window.lampac_dlna_adres + '/tracker/delete?infohash=' + encodeURIComponent(download), false, false, false, {
                        dataType: 'text'
                      });
                    } else {
                      ...
                      card.remove();
                      network["native"](window.lampac_dlna_adres + '/delete?path=' + encodeURIComponent(element.path), false, false, false, {
                        dataType: 'text'
                      });
                    }
                  }
          ...
          if (data.type == 'onlong') {
            ...
            data.menu.push({
              ...
              onSelect: function onSelect() {
                ...
                network["native"](window.lampac_dlna_adres + '/tracker/show?path=' + encodeURIComponent(magnet), function (files) {
                  Lampa.Loading.stop();
                  if (files.length) {
                    ...
                    Lampa.Select.show({
                      ...
                      onSelect: function onSelect(a) {
                        ...
                        if (select) {
                          ...
                          network["native"](window.lampac_dlna_adres + '/tracker/download?path=' + encodeURIComponent(magnet) + '&' + select + '&thumb=' + encodeURIComponent(thumb), function (result) {
                            Lampa.Loading.stop();
